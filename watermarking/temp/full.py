...
def setup(
    ...
    io: IOArgs = IOArgs(
        ...
        checkpoint_dir=Path("/hpc2hdd/home/cyang662/pre-trained-models/Llama-2-70b-hf"), # model after watermarking: /hpc2hdd/home/cyang662/watermarking/checkpoints/Llama-2-7b-hf
        out_dir=Path("out/full-finetune/Llama-2-70b-watermarking"),
    ),
